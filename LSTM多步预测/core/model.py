...
class Model:
    ...
    def build_model(self, configs):
        ...
        input_timesteps = configs['data']['input_timesteps'] if 'input_timesteps' in configs['data'] else None
        input_dim = configs['data']['input_dim'] if 'input_dim' in configs['data'] else None
