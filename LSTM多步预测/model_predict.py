...
class model_predict:
    ...
    def forecast(self, model_file_path, seq_len, input_timesteps, normalise):
        """
        ...
        predictions_pointbypoint = predictions_pointbypoint.reshape(
            int(len(predictions_pointbypoint) / (seq_len - input_timesteps)), (seq_len - input_timesteps))
